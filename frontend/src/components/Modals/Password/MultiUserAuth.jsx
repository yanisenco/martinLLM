  ...
  return (
    ...
    >
      ...
      <div className="flex items-center md:p-12 md:px-0 px-6 mt-12 md:mt-0 space-x-2 border-gray-600 w-full flex-col gap-y-8">
        <button
          type="submit"
          className="md:text-[#fb8800] md:bg-transparent md:w-[300px] text-[#222628] text-sm font-bold focus:ring-4 focus:outline-none rounded-md border-[1.5px] border-[#fb8800] md:h-[34px] h-[48px] md:hover:text-white md:hover:bg-[#fb8800] bg-[#fb8800] focus:z-10 w-full"
        >
          Reset Password
        </button>
        <button
          type="button"
          className="text-white text-sm flex gap-x-1 hover:text-[#fb8800] hover:underline -mb-8"
        ...
        <div className="flex flex-col justify-center items-center relative rounded-2xl md:bg-login-gradient md:shadow-[0_4px_14px_rgba(0,0,0,0.25)] md:px-12 py-12 -mt-4 md:mt-0">
          ...
          <div className="flex items-center md:p-12 px-10 mt-12 md:mt-0 space-x-2 border-gray-600 w-full flex-col gap-y-8">
            <button
              disabled={loading}
              type="submit"
              className="md:text-[#fb8800] md:bg-transparent text-[#222628] text-sm font-bold focus:ring-4 focus:outline-none rounded-md border-[1.5px] border-[#fb8800] md:h-[34px] h-[48px] md:hover:text-white md:hover:bg-[#fb8800] bg-[#fb8800] focus:z-10 w-full"
            >
              {loading ? "Validating..." : "Login"}
            </button>
            <button
              type="button"
              className="text-white text-sm flex gap-x-1 hover:text-[#fb8800] hover:underline"
