            ...
            <div className="flex gap-x-4 items-center">
              ...
              <div className="relative">
                <button
                  ref={openMenuButton}
                  onClick={toggleMenu}
                  className="flex items-center gap-x-2 px-4 py-1 rounded-lg bg-[#fb8800] hover:text-white text-xs font-semibold hover:bg-[#2C2F36] shadow-[0_4px_14px_rgba(0,0,0,0.25)] h-[34px] w-fit"
                >
