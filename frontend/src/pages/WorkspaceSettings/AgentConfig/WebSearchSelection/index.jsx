    ...
    <div className="border-b border-white/40 pb-4">
      ...
      <div hidden={!enabled}>
        <div className="relative">
          ...
          {searchMenuOpen ? (
            <div className="absolute top-0 left-0 w-full max-w-[640px] max-h-[310px] overflow-auto white-scrollbar min-h-[64px] bg-[#18181B] rounded-lg flex flex-col justify-between cursor-pointer border-2 border-[#fb8800] z-20">
            ...
            <button
              className="w-full max-w-[640px] h-[64px] bg-[#18181B] rounded-lg flex items-center p-[14px] justify-between cursor-pointer border-2 border-transparent hover:border-[#fb8800] transition-all duration-300"
              type="button"
